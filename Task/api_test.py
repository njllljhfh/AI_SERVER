...
if __name__ == '__main__':
    ...
    # api_algorithm3(person_choice=PersonChoice.no_need.value)  # 人员不需要进行选择
    api_algorithm3(person_choice=PersonChoice.need.value, manual_choice=False)  # 人员需要进行选择，第一次调用
    # api_algorithm3(person_choice=PersonChoice.need.value, manual_choice=True)  # 人员需要进行选择，第二次调用
